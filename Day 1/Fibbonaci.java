...
Read more: https://javarevisited.blogspot.com/2017/07/top-50-java-programs-from-coding-Interviews.html#ixzz7Q4zjyh5i
*/
...
class Fibbonaci {
    ...
    public static int fib(int val) {
        ...
        memo.put(val, res); // Puuting the calculated value to memo
